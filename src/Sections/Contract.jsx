...
const Contract = () => {
  ...
  return (
    <div  className={`${darkMode ? "dark bg-black" : "light bg-transparent "} pb-20 `}>
      <section id='contract'  className={`${darkMode ? "dark bg-gray-800" : "light bg-red-100 "} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10  `}  >
      <div data-aos="zoom-in" className=' bg-white dark:bg-black p-10 flex flex-col justify-center items-start gap-4 rounded-xl ' >
        ...
        <h1 data-aos="zoom-in" data-aos-delay="400" className=' text-black text-[40px] font-semibold leading-10 dark:text-white  ' >Quisque placerat metus sapien, viverra semper ipsum commodo vel. </h1>
        <p data-aos="zoom-in" data-aos-delay="600" className=' text-xl text-gray-600 text-justify dark:text-white'  >Ut non eros nunc. Vivamus eget sem interdum, sodales diam et, euismod sapien. Nulla facilisi.uisque placerat metus sapien, viverra semper ipsum commodo vel.Ut non eros nunc. </p>
