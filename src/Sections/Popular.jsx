      ...
      >
        ...
        >
          <div>
            <h3
              data-aos="zoom-in"
              className=" text-red-500 font-semibold dark:text-white "
            >
              POPULAR AREAS{" "}
            </h3>
            <h1
          ...
          <div className=" grid lg:grid-cols-3 col-span-2 grid-cols-1 justify-center items-center gap-6 ">
            <div
              ...
              className=" bg-cover bg-center h-[400px] rounded-xl "
            ></div>
            <div
              data-aos="zoom-in"
              data-aos-delay="400"
        ...
        <div
          id="bottm"
          className=" w-full grid lg:grid-cols-3 lg:justify-center justify-start items-center gap-6 "
        >
          <div
            data-aos="slide-up"
            data-aos-delay="200"
